...
- **05.data-platform/**  
  - End-to-end integration of ingestion, orchestration, warehouse, and analytics  
  - API ingestion pipelines (Adrian Brudaru’s workshop)  
  - PySpark experiments for scalable transformations  
  - Resources:  
    - [Data Ingestion from APIs](https://www.youtube.com/watch?v=oLXhBM7nf2Q)  
...
- Experimented with PySpark for scalable ETL workflows  
- Integrated API ingestion pipelines into the data platform  
...
**Samwel Njogu**  
Focused on reproducible, examiner-friendly data engineering workflows with ethical framing and cost control.
